...
const runner = new RunContiniously(500)
...
export default handleActions({
  ...
  [Actions.init.toString()]: (state, action) => ({
    ...state,
    player: action.payload,
    state: "init",
  }),
  [Actions.tracksIndex.toString()]: (state, action) => ({
    ...state,
    tracksIndex: action.payload,
  }),
  [Actions.playlist.toString()]: (state, action: ReduxActions.Action<{
    index,
    playlist,
  }>) => ({
    ...state,
  ...
  [SearchActions.searchActions.complete.toString()]: (state, action) => ({
    ...state,
    playlistId: null,
  }),
  [Actions.duration.toString()]: (state, action) => ({
    ...state,
    duration: action.payload,
  }),
  [Actions.state.toString()]: (state, action) => ({
    ...state,
    state: action.payload,
  }),
  [Actions.progress.toString()]: (state, action) => ({
    ...state,
    progress: action.payload,
  }),
  [Actions.muted.toString()]: (state, action) => ({
    ...state,
    muted: action.payload,
  }),
  [Actions.volume.toString()]: (state, action) => ({
    ...state,
    volume: action.payload,
  }),
  [Actions.popup.toString()]: (state, action) => ({
    ...state,
    popup: action.payload,
  }),
  [Actions.error.toString()]: (state, action) => ({
    ...state,
    error: action.payload,
    state: "error",
  }),
  [Actions.seeking.toString()]: (state, action) => ({
    ...state,
